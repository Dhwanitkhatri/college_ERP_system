...
export const  createSubject = async (req, res) => {
    ...
    try {
        const { subject_id, subject_name, credit ,faculty_id , semester , lecture_per_week} = req.body;
      
        // Validation to require fields
        if (!subject_id || !subject_name || !course_id || !credit || !faculty_id || !semester || !lecture_per_week) {
            await t.rollback();
