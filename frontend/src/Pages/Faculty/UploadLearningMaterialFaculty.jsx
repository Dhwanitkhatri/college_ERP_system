...
export default function UploadLearningMaterialFaculty() {
  ...
  useEffect(() => {
    ...
    api
      .get(`/api/learning-materials/subject?class_id=${selectedClass}`)
      .then((res) => {
  ...
  try {
    ...
    formData.append("class_pk", data.class);
    ...
    const res = await api.post("/api/learning-materials/", formData, {
      headers: {
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="form-field !my-0">
              ...
              <label className="custom-label">Material Title</label>
          ...
          <div className="form-field mt-6">
            ...
            <label className="custom-label">Upload Files</label>
          ...
          <div className="flex items-center gap-4 mt-8">
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2 bg-black dark:bg-white text-white dark:text-black rounded-md font-medium hover:opacity-90 transition-opacity disabled:opacity-50"
            >
