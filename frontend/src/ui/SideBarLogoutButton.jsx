...
const SideBarLogoutButton = ({ onClick }) => {
  return (
    <div
      onClick={onClick}
      className="SidebarLogoutButtonDiv flex items-center justify-center px-[5%] py-[3%] rounded-xl border-[2px] 
      hover:bg-gray-100 hover:border-red-300 hover:text-red-500 cursor-pointer
